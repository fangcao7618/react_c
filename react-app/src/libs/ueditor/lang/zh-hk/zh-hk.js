...
UE.I18N['zh-hk'] = {
  ...
  'insertvideo': {
    'static': {
      'lang_tab_insertV': "插入音視頻",
      'lang_tab_searchV': "搜索音視頻",
      'lang_tab_uploadV': "上傳音視頻",
      'lang_video_url': "音視頻網址",
      'lang_video_size': "音視頻尺寸",
      'lang_videoW': "寬度",
      'lang_videoH': "高度",
      'lang_alignment': "對齊方式",
      'videoSearchTxt': {
    ...
    '"default"': "默認",
    'block': "獨占一行",
    'urlError': "輸入的音視頻地址有誤，請檢查後再試！",
    'loading': " &nbsp;音視頻加載中，請等待……",
    'clickToSelect': "點擊選中",
    'goToSource': '訪問源音視頻',
    'noVideo': " &nbsp; &nbsp;抱歉，找不到對應的音視頻，請重試！",
