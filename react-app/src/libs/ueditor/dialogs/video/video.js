...
(function() {
  ...
  function createPreviewVideo(url) {
    ...
    var allowFiles = editor.options.videoAllowFiles;
    ...
    var str = '';
    if (isAllow) {
      // 改写 type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"
      str = '<embed class="previewVideo video-js"' +
        ' src="' + conUrl + '"' +
        ' width="' + 420 + '"' +
        ' height="' + 280 + '"' +
        ' autostart="false" controls autoplay preload="none" loop="false" />';
    }

    $G("preview").innerHTML = '<div class="previewMsg"><span>' + (isAllow ? lang.urlError : lang.errorFileType) + '</span></div>' + str;
  }
